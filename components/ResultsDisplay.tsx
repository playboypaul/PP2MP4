...
const VideoCard: React.FC<{ result: VideoResult, index: number }> = ({ result, index }) => {
    ...
    return (
        <div 
            className="purple-card rounded-lg shadow-lg overflow-hidden transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl flex flex-col opacity-0 animate-fade-in"
        ...
        >
            ...
            >
                 ...
                 <div className={`custom-video-controls absolute inset-0 flex flex-col justify-between p-2 transition-opacity duration-300 bg-black bg-opacity-40 ${showControls || !isPlaying ? 'opacity-100' : 'opacity-0'} group-hover:opacity-100`}>
                    ...
                    <div className="flex justify-center items-center">
                        <button onClick={togglePlayPause} className="text-white hover:text-purple-light transition-colors">
            ...
            <div className="p-4 flex flex-col flex-grow">
                <h3 className="font-bold text-lg text-purple-light mb-2">Slide {result.slideNumber}</h3>
                ...
                <a
                    ...
                    className="mt-4 w-full inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white purple-button focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800"
                >
                    <DownloadIcon />
        ...
        <div className="flex flex-col items-center w-full">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
                 <button
                    ...
                    disabled={isZipping}
                    className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white purple-button focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    <ZipIcon />
