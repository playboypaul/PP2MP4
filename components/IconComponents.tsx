...
export const RetryIcon = () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 2l4 4-4 4"></path>
...
export const VolumeOffIcon = () => (
  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M10 17a9.953 9.953 0 01-4.542-1.074l-1.473 1.473a1 1 0 101.414 1.414l1.473-1.473A9.982 9.982 0 0010 17zM1.458 10c1.274 4.057 5.022 7 9.542 7a9.953 9.953 0 004.542-1.074l-1.473-1.473A8.014 8.014 0 0110 15c-3.454 0-6.553-2.042-8.08-5z" />
  </svg>
);
...
export const FullscreenExitIcon = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 4H4m0 0v4M4 4l5 5m1-1h4m0 0v-4m0 4l-5-5M8 20H4m0 0v-4m0 4l5-5m1 1h4m0 0v4m0-4l-5 5" />
    </svg>
);
