    ...
    return (
        <div className="w-full max-w-7xl mx-auto opacity-0 animate-fade-in">
            ...
            <div className="space-y-8">
                {slides.map(slide => (
                    <div key={slide.slideNumber} className="purple-card rounded-lg p-6 shadow-lg">
                        <h3 className="font-bold text-xl text-purple-light mb-3">Slide {slide.slideNumber}</h3>
                                    ...
                                    {slide.imageBases64.map((imageBase64, index) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`relative rounded-lg overflow-hidden cursor-pointer transition-all duration-300 aspect-video transform ${isSelected ? 'border-purple-glow scale-105 shadow-lg' : 'ring-2 ring-transparent hover:border-purple-glow hover:scale-105'}`}
                                            >
                                                <img
            ...
            <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <button
                    onClick={onGenerate}
                    className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white purple-button focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900"
                >
